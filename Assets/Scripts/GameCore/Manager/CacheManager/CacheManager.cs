...
public sealed partial class CacheManager : CommandBehaviour, IParam, IRegister
{
	...
	public System.Object GetParameter (uint _inst, params System.Object[] _params)
	{
		...
		case CacheParam.GET_ABILITY_PATH:
			output = (System.Object)GetCachePath (_inst, _params);
			break;

		case CacheParam.GET_AUDIO_PATH:
			output = (System.Object)GetCachePath (_inst, _params);
			break;

		case CacheParam.GET_SPRITE_PATH:
			output = (System.Object)GetCachePath (_inst, _params);
			break;

		case CacheParam.GET_POST_EFFECT_PATH:
			output = (System.Object)GetCachePath (_inst, _params);
			break;
		...
		case CacheParam.GET_ABILITY:
			output = GetCache (
				GetCachePath (CacheParam.GET_ABILITY_PATH, _params), 
				GetCacheAsset (CacheParam.GET_ABILITY_PATH, _params), 
				(bool)_params [1]);
			break;

		case CacheParam.GET_AUDIO:
			output = GetCache (
				GetCachePath (CacheParam.GET_AUDIO_PATH, _params), 
				GetCacheAsset (CacheParam.GET_AUDIO_PATH, _params), 
				(bool)_params [1]);
			break;

		case CacheParam.GET_SPRITE:
			output = GetCache (
				GetCachePath (CacheParam.GET_SPRITE_PATH, _params), 
				GetCacheAsset (CacheParam.GET_SPRITE_PATH, _params), 
				(bool)_params [1]);
			break;

		case CacheParam.GET_POST_EFFECT:
			output = GetCache (
