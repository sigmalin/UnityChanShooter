...
public class MultiShooter : MonoBehaviour {
	...
	void Update () {
        ...
        if (Input.GetButtonDown("Fire1"))
        {
			...
			GameObject s2 = (GameObject)Instantiate(Sig, this.transform.position, this.transform.rotation);
			s2.GetComponent<BeamRay>().BeamEnd = this.transform.position + this.transform.forward * 3f;
        }
